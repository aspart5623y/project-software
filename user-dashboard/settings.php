            ...
            <div class="pager mt-1 bg-white shadow-sm">
                <ul class="breadcrumb bg-transparent rounded-0">
                    ...
                    <li class="breadcrumb-item active">
                        <a href="<?php echo SITEURL ?>user-dashboard/settings.php" class="text-primary">
                            Admin Dashboard
                        </a>
                    </li>
                </ul>
                                ...
                                <div class="col-lg-7">
                                    <div class="dashboard-content p-1 p-md-5">
                                        <div class="dashboard-info">
                                            ...
                                            <a href="<?php echo SITEURL ?>user-dashboard/password-setting.php   " class="btn btn-light border px-5 py-2">Change your password</a>
                                        </div>
