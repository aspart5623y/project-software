                        ...
                        <div class="col-md-3 col-6 border-right">
                            <div class="rate-counter">
                                <div class="media mb-n3 justify-content-center">
                                    <i class="fas fa-user-plus text-primary" style="font-size: 30px;"></i>
                                    <div class="body ml-3">
                                        <h6 class="text-uppercase m-0">New Users</h6> 
                        ...
                        <div class="col-md-3 col-6 border-right">
                            <div class="rate-counter">
                                <div class="media mb-n3 justify-content-center">
                                    ...
                                    <div class="body ml-3">
                                        <h6 class="text-uppercase m-0">Total Users</h6> 
                                        <p class="time text-muted">Last 7 days</p>
                                    </div>
                                </div>
                                <h1 class="counter">232</h1>
                            </div>
                        </div>
